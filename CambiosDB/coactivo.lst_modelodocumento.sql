-- Function: coactivo.lst_modelodocumento(character varying, refcursor)

-- DROP FUNCTION coactivo.lst_modelodocumento(character varying, refcursor);
...
if p_idsigma = ''  then 
	p_idsigma := '0';
		...
		OPEN p_ref  FOR
			select 	a.id	,b.idsigma as mdocumento,a.cnrodocumento,a.casunto,a.notas, a.descripcion, a.mensageobs, b.vdescri			
