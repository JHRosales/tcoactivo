...
//Evento check objetos
$("input[name='estobj']").live('click',function(){
    ...
    if($(this).is(":checked"))
        ...
        estado = 0;
    var data = $('#tblResultObjeto').jqGrid('getRowData', rowId);

    $.ajax({
        url: jQuery.scriptPath + "index.php/sistema/guardarpermiso",
        type: 'POST',
        cache: false,
        data: "cidUsuario="+$("#cidusuarioperm").val()+"&idObjeto="+data.cidobj+"&estObjeto="+estado,
